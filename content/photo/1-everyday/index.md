...
- src: norikura-mount.JPG
  name: 乗鞍高原
  params:
    order: 4
    description: 乗鞍岳から見た麓の景色。途中で熊に遭遇したときは死ぬかと思った。

- src: hieizan-susuki.JPG
  name: 比叡山のすすき
  params:
    order: 5
    description: 比叡山の頂上付近にあるすすき。

- src: machida-squirrel.jpg
  name: 町田リス園のエゾリス
  params:
    order: 6
    description: 町田リス園にいる凶暴なエゾリス。シマリスをイメージして訪れてはいけない。

- src: fsw-nsx.jpg
  name: FSWで展示されていたNSX
  params:
    order: 7
    description: SUPERT GT 富士スピードウェイにて展示されていたNSX。かっこいい！

- src: sunrize-seto.jpg
  name: サンライズ瀬戸
  params:
    order: 8
    description: 東京行きのサンライズ瀬戸。初めての夜行列車。

- src: shukatsu.jpg
  name: 合同説明会
  params:
    order: 9
    description: 初めての合同説明会。暗い気持ちで就活していたので、写真も暗くなってしまった。

- src: senbatsu-osaka.jpg
  name: センバツ
  params:
    order: 10
    description: センバツの大阪桐蔭対履正社。熱い戦いでした。

- src: okuribi.jpg
  name: 五山送り火
  params:
    order: 11
    description: 京都と言えばやっぱり五山送り火。これを見ないで夏は越せないという感じ。

- src: taiwan-shrine.jpg
  name: 台湾のお寺
  params:
    order: 12
    description: 台湾旅行で訪れたお寺。豪華絢爛。

- src: kyu-fun.jpg
  name: 九份
  params:
    order: 13
    description: 台湾の九份。観光ブックの写真はきれいすぎる。

- src: midnight-nenbutsu.jpg
  name: ミッドナイト念仏
  params:
    order: 14
    description: 毎年知恩院で開催されるミッドナイト念仏。みんなで夜通し木魚を叩く。だんだん木魚を叩く間隔が短くなってくる現象が見られる。

- src: enoshima.jpg
  name: 江ノ島
  params:
    order: 15
    description: 夏！江ノ島！パーティーピープル！

- src: shirahama.jpg
  name: 白浜
  params:
    order: 16
    description: 白浜の海。めちゃくちゃ青々としてる。

- src: amano-hashidate.jpg
  name: 天橋立
  params:
    order: 17
    description: 晴れた日の天橋立。日本三景の力は偉大。

- src: kitsune.jpg
  name: 蔵王キツネ村
  params:
    order: 18
    description: 東北にあるキツネのパラダイス、蔵王キツネ村。キツネは間近で見るとけっこう怖い。

- src: matsushima.jpg
  name: 松島
  params:
    order: 19
    description: 日本三景のひとつ、松島。ちょうど雨があがってくれた。
